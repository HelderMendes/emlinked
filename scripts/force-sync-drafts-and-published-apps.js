...
async function forceSyncDraftsAndPublished() {
    console.log(
        '🚀 Force updating both Published and Draft documents for /apps in Sanity...\n',
    );
    ...
    const nlPageBlocks = [
        ...
        },
        {
            ...
            sectionTag: 'KLANTEN & REFERENTIES',
            sectionTitle:
    ...
    await client
        ...
        .commit();
    await client.delete('drafts.page-apps-nl').catch(() => {});
    console.log(
        '✓ Successfully updated page-apps-nl with sectionTag, sectionTitle, and sectionSubtitle in Sanity!',
    );
    ...
    await client
        ...
        .commit();
    await client.delete('drafts.page-apps-en').catch(() => {});
    console.log(
        '✓ Successfully updated page-apps-en with sectionTag, sectionTitle, and sectionSubtitle in Sanity!',
    );
}

forceSyncDraftsAndPublished();
