...
export default async function ArticleDetailPage({ params }: ArticleDetailPageProps) {
    ...
    return (
        <main className='flex-1 bg-background text-foreground relative overflow-hidden'>
            ...
            {/* ── ARTICLE CONTENT SECTION (LIGHT BACKGROUND) ── */}
            <article className='px-6 py-16 max-w-4xl mx-auto space-y-10 text-left relative z-10'>
                {/* Main Hero Image */}
                <div className='relative w-full h-[320px] md:h-[480px] rounded-3xl overflow-hidden border border-slate-200 shadow-xl bg-slate-100'>
                    <Image
                        src={heroImgUrl}
                        alt={article.title}
                        fill
