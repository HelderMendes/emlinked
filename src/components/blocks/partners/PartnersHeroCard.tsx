...
export function PartnersHeroCard({ isEn = false }: PartnersHeroCardProps) {
    return (
        <BorderBeam colorVariant='orange'>
            <div className='relative w-full max-w-lg mx-auto rounded-3xl bg-slate-900/90 text-white border border-teal/30 p-6 md:p-8 shadow-2xl backdrop-blur-xl space-y-6 overflow-hidden'>
                {/* Header Badge */}
                ...
                <div className='divide-y divide-white/10 py-1'>
                    ...
                    <div className='py-3 flex items-center justify-between'>
                        <div className='flex items-center gap-3'>
                            <span className='w-8 h-8 rounded-lg bg-teal/15 text-teal border border-teal/30 flex items-center justify-center text-xs font-bold shrink-0'>
                                MS
                            </span>
                            <div>
                ...
                <div className='pt-2 border-t border-white/10 flex items-center justify-between text-xs text-white/70'>
                    <span className='flex items-center gap-1.5 text-teal font-mono font-medium'>
