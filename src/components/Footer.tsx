...
export default function Footer({ locale = 'nl' }: FooterProps) {
    ...
    return (
        <footer className="w-full bg-[#060e32] text-white border-t border-white/10 pt-16 pb-12 transition-all">
            <div className="mx-auto max-w-8xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 max-w-7xl mx-auto pb-12 border-b border-white/10">
                    ...
                    <div className="md:col-span-4 flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-2 mt-2 text-xs text-white/60">
                            <a href="tel:+310887077000" className="flex items-center gap-2 hover:text-[#ff9400] transition-colors">
                                <svg className="h-3.5 w-3.5 text-[#ff9400] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.622c0-1.27.75-2.385 1.815-2.852a11.247 11.247 0 0113.821 2.852c1.066.467 1.815 1.581 1.815 2.852a46.211 46.211 0 01-19.451 0z" />
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.622a46.211 46.211 0 0019.45 0v11.127a46.21 46.21 0 01-19.45 0V6.622z" />
                                </svg>
                                <span>{t.phone}</span>
                            </a>
                    ...
                    <div className="md:col-span-2 flex flex-col gap-4">
                        <h4 className="text-xs font-bold uppercase tracking-wider text-white/90 font-mono">
                            {t.product}
                        </h4>
                        <ul className="flex flex-col gap-2.5 text-xs text-white/60">
                            <li>
                                <Link href={getPath('/oplossingen/vastgoedbeheer-software')} className="hover:text-[#ff9400] transition-colors">
                                    {t.vastgoedbeheer}
                                </Link>
                            </li>
                            <li>
                                <Link href={getPath('/oplossingen/huurdersportaal')} className="hover:text-[#ff9400] transition-colors">
                                    {t.huurdersportaal}
                                </Link>
                            </li>
                            <li>
                                <Link href={getPath('/oplossingen/payment')} className="hover:text-[#ff9400] transition-colors">
                                    {t.payment}
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div className="md:col-span-2 flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-2.5 text-xs text-white/60">
                            <li>
                                <Link href={getPath('/integraties/business-central')} className="hover:text-[#ff9400] transition-colors">
                                    {t.businessCentral}
                                </Link>
                            </li>
                            <li>
                                <Link href={getPath('/integraties/document-capture')} className="hover:text-[#ff9400] transition-colors">
                                    {t.documentCapture}
                                </Link>
                            </li>
                            <li>
                                <Link href={getPath('/integraties/direct-banking')} className="hover:text-[#ff9400] transition-colors">
                                    {t.directBanking}
                                </Link>
                            </li>
                            <li>
                                <Link href={getPath('/kennisbank/box3-check')} className="text-[#ff9400] font-semibold hover:underline">
                                    {t.box3}
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div className="md:col-span-2 flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-2.5 text-xs text-white/60">
                            <li>
                                <Link href={getPath('/team')} className="hover:text-[#ff9400] transition-colors">
                                    {t.team}
                                </Link>
                            </li>
                            <li>
                                <Link href={getPath('/referenties')} className="hover:text-[#ff9400] transition-colors">
                                    {t.referenties}
                                </Link>
                            </li>
                            <li>
                                <Link href={getPath('/blog')} className="hover:text-[#ff9400] transition-colors">
                                    {t.blog}
                                </Link>
                            </li>
                            <li>
                                <Link href={getPath('/contact')} className="hover:text-[#ff9400] transition-colors font-semibold">
                                    {t.contact}
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div className="md:col-span-2 flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-2.5 text-xs text-white/60">
                            <li>
                                <Link href="/docs" className="hover:text-[#ff9400] transition-colors">
                                    {t.docs}
                                </Link>
                            </li>
                            <li>
                                <Link href={getPath('/help')} className="hover:text-[#ff9400] transition-colors">
                                    {t.support}
                                </Link>
                            </li>
                        </ul>
                        ...
                        <div className="flex gap-3 mt-1.5">
                            <a href="https://linkedin.com" className="h-7 w-7 rounded-md border border-white/20 flex items-center justify-center text-white/80 hover:text-white hover:border-[#ff9400] hover:text-[#ff9400] transition-colors" aria-label="LinkedIn">
                            ...
                            <a href="https://x.com" className="h-7 w-7 rounded-md border border-white/20 flex items-center justify-center text-white/80 hover:text-white hover:border-[#ff9400] hover:text-[#ff9400] transition-colors" aria-label="X (Twitter)">
                ...
                <div className="mt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 md:gap-6 text-[10px] text-white/40">
                        <Link href={getPath('/privacybeleid')} className="hover:text-[#ff9400] transition-colors">
                            {t.disclaimer}
                        </Link>
                        <span className="text-white/10">|</span>
                        <Link href={getPath('/algemene-voorwaarden')} className="hover:text-[#ff9400] transition-colors">
                            {t.terms}
                        </Link>
                    </div>
                </div>
