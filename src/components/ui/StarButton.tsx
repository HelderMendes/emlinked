...
function StarBackground() {
    return (
        ...
        >
            <g className='fill-neutral-950/20 dark:fill-white/50'>
                {/* Star Paths */}
                <path d='M32.34 26.68C32.34 26.3152 32.0445 26.02 31.68 26.02C31.3155 26.02 31.02 26.3152 31.02 26.68C31.02 27.0448 31.3155 27.34 31.68 27.34C32.0445 27.34 32.34 27.0448 32.34 26.68Z' />
                <path
                    fillRule='evenodd'
                    clipRule='evenodd'
...
export function StarButton({
    ...
    lightWidth = 110,
    duration = 4,
    lightColor = 'var(--color-primary)', // Emlinked Corporate Orange
    borderWidth = 1.5,
    className = '',
    ...props
}: StarButtonProps) {
...
interface StarLinkProps extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
    children: ReactNode;
    href: string;
    lightWidth?: number;
    duration?: number;
