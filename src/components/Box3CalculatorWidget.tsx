...
export function Box3CalculatorWidget() {
    return (
        <div className='p-8 md:p-10 rounded-3xl border border-teal/30 bg-texture-navy text-white shadow-2xl relative overflow-hidden group backdrop-blur-xl'>
            <div className='absolute -right-20 -bottom-20 w-80 h-80 bg-teal/20 rounded-full blur-[80px] pointer-events-none group-hover:bg-teal/30 transition-all duration-700' />
            ...
            <div className='flex flex-col gap-6'>
                ...
                <div className='bg-white/5 border border-white/10 rounded-2xl p-5 flex flex-col gap-3 backdrop-blur-md hover:border-white/20 transition-all'>
                    <div className='flex justify-between items-center text-xs text-white/90'>
                        ...
                        <span className='font-bold text-teal text-sm bg-teal/10 border border-teal/20 px-2.5 py-0.5 rounded-md'>
                            75 eenheden
                        </span>
                    </div>
                    <div className='w-full bg-white/10 h-2.5 rounded-full relative overflow-hidden p-0.5'>
                        <div className='bg-gradient-to-r from-teal to-teal/70 h-full rounded-full w-[65%] shadow-[0_0_10px_rgba(245,158,11,0.5)]' />
                    </div>
                </div>
                ...
                <div className='bg-white/5 border border-white/10 rounded-2xl p-5 flex flex-col gap-3 backdrop-blur-md hover:border-white/20 transition-all'>
                    ...
                    <div className='w-full bg-white/10 h-2.5 rounded-full relative overflow-hidden p-0.5'>
                        <div className='bg-gradient-to-r from-teal to-teal/70 h-full rounded-full w-[50%] shadow-[0_0_10px_rgba(245,158,11,0.5)]' />
                    </div>
                </div>

                {/* Result Box */}
                <div className='bg-gradient-to-br from-teal/20 via-white/5 to-transparent border border-teal/40 rounded-2xl p-6 flex flex-col gap-3 text-left backdrop-blur-md shadow-lg'>
                    ...
                    <p className='text-xs text-white/70 leading-normal font-light'>
                        Op basis van sluitende kostenregistratie en werkelijke
                        rendementshefboom in Business Central.
                    </p>
                </div>
            </div>
        </div>
